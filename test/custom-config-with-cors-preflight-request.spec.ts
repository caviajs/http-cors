...
it('should add CORS-preflight request headers and not execute handler (custom config builder)', async () => {
  const httpRouter: HttpRouter = new HttpRouter();

  httpRouter
    .intercept(HttpCors.setup(request => {
      return {
...
it('should add CORS-preflight request headers and not execute handler (custom config object)', async () => {
  const httpRouter: HttpRouter = new HttpRouter();
